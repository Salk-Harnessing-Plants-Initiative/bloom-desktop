...
- [ ] 6.1 Test: Delete ~/.bloom/ directory
- [ ] 6.2 Test: Start app in development mode
- [ ] 6.3 Test: Verify database created at ~/.bloom/dev.db (not prisma/dev.db)
- [ ] 6.4 Test: Verify scans default shows ~/.bloom/dev-scans in config form
- [ ] 6.5 Test: Try to save with non-existent directory
- [ ] 6.6 Test: Verify validation error displayed
- [ ] 6.7 Test: Create directory and save again
- [ ] 6.8 Test: Verify save succeeds
- [ ] 6.9 Test: Verify help text visible and readable
- [ ] 6.10 Test: Start app in production mode (set NODE_ENV=production)
- [ ] 6.11 Test: Verify database at ~/.bloom/data/bloom.db (unchanged)
- [ ] 6.12 Test: Verify scans default at ~/.bloom/scans (unchanged)

### Phase 7: Integration Testing

- [ ] 7.1 Test: Perform full scan in development with dev-scans directory
- [ ] 7.2 Test: Verify scan images saved to ~/.bloom/dev-scans
- [ ] 7.3 Test: Verify scan metadata saved to ~/.bloom/dev.db
- [ ] 7.4 Test: Check that production scans (if any) at ~/.bloom/scans are separate
- [ ] 7.5 Test: Verify no file conflicts between dev and prod environments
