...
- [ ] 6.4 Manual test: Change scanner name and save
- [ ] 6.5 Manual test: Return to Layout - verify name updated (no restart)
- [ ] 6.6 Manual test: Restart app - verify name persists
