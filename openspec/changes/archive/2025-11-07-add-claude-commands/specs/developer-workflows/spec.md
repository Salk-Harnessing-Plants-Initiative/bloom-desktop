...
Provides standardized Claude slash commands that guide developers through common workflows including linting, testing, PR creation, code review, and specialized tasks like Python bundling and hardware testing.
