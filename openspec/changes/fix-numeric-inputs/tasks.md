...
1. [ ] **Create unit test file for metadata validation**
...
2. [ ] **Add E2E test for clearing and retyping numeric fields**
...
3. [ ] **Update existing E2E test for zero value handling**
...
5. [ ] **Update ScanMetadata type to support empty state**
...
6. [ ] **Update Wave Number onChange handler**
...
10. [ ] **Store raw input value to detect decimals**
...
11. [ ] **Update initial metadata state**
...
16. [ ] **Extract validation logic to utility (optional)**
