...
- [x] 1.2 Add compile-time test that invalid status strings (e.g., `'CAPTURED'`) produce a type error
...
- [x] 2.5 Annotate status string literals in `image-uploader.ts` status transitions (lines 253, 290, 309)
