...
INSERT INTO "new_GraviScanPlateAssignment" ("createdAt", "custom_note", "experiment_id", "id", "plate_barcode", "plate_index", "scanner_id", "selected", "transplant_date", "updatedAt") SELECT "createdAt", "custom_note", "experiment_id", "id", "plate_barcode", "plate_index", "scanner_id", "selected", "transplant_date", "updatedAt" FROM "GraviScanPlateAssignment";
