...
**Solution:** A 500ms startup delay is added in `src/main/database.ts` during E2E mode:
...
- With 500ms delay: 100% of tests pass (181/181) - required for both local and CI
