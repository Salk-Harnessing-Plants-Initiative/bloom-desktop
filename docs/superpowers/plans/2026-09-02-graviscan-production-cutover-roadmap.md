...
| 2 | Cutover mechanics (#306) | Tier 1, but only #279/#364/#226/#361 hard-block *execution* — runbook drafting has no code dependency and can start in parallel | Small (pre-flight check tooling) | #306, #226, #361, #204, #284, #325, #364 | Not started |
