...
| --- | ---------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1   | Correctness & security hardening                                 | —                                                                                                                                              | Mostly no; #93 requires new protocol-handler registration + path-traversal validation logic, not a flag flip          | #93, #96, #97, #47, #40, #198, #249                                                            | **Merged** — PR #280, commit `995c1df` (2026-08-04). Also fixed 5 real bugs found across 2 post-implementation `/review-pr` rounds after the original merge-ready state; see `openspec/changes/archive/2026-08-05-harden-cylinderscan-tier1/`. Follow-ups filed, not fixed in this tier: #282 (seed script idempotency), #287 (mid-scan Python crash strands UI)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| 2   | Delete & upload data-integrity + acquisition metadata completion | — (parallel to 1; shares `image-uploader.ts` with Tier 1's #97, disjoint regions)                                                              | Yes — one small new `db:scans:checkDuplicate`-style handler (#120), possibly a metadata-readback extension (pilot #3) | #79, #105, #120, pilot #3, (#110 optional)                                                     | **Merged** — PR #304, commit `dad00f3` (2026-08-06). Went through a 3-round pre-implementation `openspec-review` plus a post-implementation 5-lens `/review-pr` that found and fixed a real bug (an unhandled-exception path in upload verification could leave an image stuck at `'uploading'`, reintroducing the duplicate-remote-row risk this tier exists to close); see `openspec/changes/archive/2026-08-06-add-cylinderscan-delete-upload-integrity/`. Acquisition-metadata readback (pilot #3) was **not** implemented — confirmed still a real gap and filed as its own follow-up (#299), not silently dropped. Also filed: #297 (local↔cloud UUID traceability + delete-then-rescan cloud-storage orphaning), #298 (widened upload audit/reconciliation tool, now also covering a batch-deferred-verification crash window found in review). #110 commented with the now-satisfied documentation criterion; benchmarking/configurability left open. |
