...
| --- | ---------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1   | Correctness & security hardening                                 | —                                                                                                                                              | Mostly no; #93 requires new protocol-handler registration + path-traversal validation logic, not a flag flip          | [#93](https://github.com/Salk-Harnessing-Plants-Initiative/bloom-desktop/issues/93), [#96](https://github.com/Salk-Harnessing-Plants-Initiative/bloom-desktop/issues/96), [#97](https://github.com/Salk-Harnessing-Plants-Initiative/bloom-desktop/issues/97), [#47](https://github.com/Salk-Harnessing-Plants-Initiative/bloom-desktop/issues/47), [#40](https://github.com/Salk-Harnessing-Plants-Initiative/bloom-desktop/issues/40), [#198](https://github.com/Salk-Harnessing-Plants-Initiative/bloom-desktop/issues/198), [#249](https://github.com/Salk-Harnessing-Plants-Initiative/bloom-desktop/issues/249) | **Merged** — [PR #280](https://github.com/Salk-Harnessing-Plants-Initiative/bloom-desktop/pull/280), commit `995c1df` (2026-08-04). Also fixed 5 real bugs found across 2 post-implementation `/review-pr` rounds after the original merge-ready state; see `openspec/changes/archive/2026-08-05-harden-cylinderscan-tier1/`. Follow-ups filed, not fixed in this tier: [#282](https://github.com/Salk-Harnessing-Plants-Initiative/bloom-desktop/issues/282) (seed script idempotency), [#287](https://github.com/Salk-Harnessing-Plants-Initiative/bloom-desktop/issues/287) (mid-scan Python crash strands UI). All 7 tracking issues above closed 2026-08-06 — PR #280 shipped the fixes but carried no closing keywords, so they sat open until this audit caught it; each closed with a comment linking the merge commit and the specific code verified.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| 2   | Delete & upload data-integrity + acquisition metadata completion | — (parallel to 1; shares `image-uploader.ts` with Tier 1's #97, disjoint regions)                                                              | Yes — one small new `db:scans:checkDuplicate`-style handler (#120), possibly a metadata-readback extension (pilot #3) | [#79](https://github.com/Salk-Harnessing-Plants-Initiative/bloom-desktop/issues/79), [#105](https://github.com/Salk-Harnessing-Plants-Initiative/bloom-desktop/issues/105), [#120](https://github.com/Salk-Harnessing-Plants-Initiative/bloom-desktop/issues/120), pilot #3, ([#110](https://github.com/Salk-Harnessing-Plants-Initiative/bloom-desktop/issues/110) optional)                                                                                                                                                                                                                                         | **Merged** — [PR #304](https://github.com/Salk-Harnessing-Plants-Initiative/bloom-desktop/pull/304), commit `dad00f3` (2026-08-06). Went through a 3-round pre-implementation `openspec-review` plus a post-implementation 5-lens `/review-pr` that found and fixed a real bug (an unhandled-exception path in upload verification could leave an image stuck at `'uploading'`, reintroducing the duplicate-remote-row risk this tier exists to close); see `openspec/changes/archive/2026-08-06-add-cylinderscan-delete-upload-integrity/`. Acquisition-metadata readback (pilot #3) was **not** implemented — confirmed still a real gap and filed as its own follow-up ([#299](https://github.com/Salk-Harnessing-Plants-Initiative/bloom-desktop/issues/299)), not silently dropped. Also filed: [#297](https://github.com/Salk-Harnessing-Plants-Initiative/bloom-desktop/issues/297) (local↔cloud UUID traceability + delete-then-rescan cloud-storage orphaning), [#298](https://github.com/Salk-Harnessing-Plants-Initiative/bloom-desktop/issues/298) (widened upload audit/reconciliation tool, now also covering a batch-deferred-verification crash window found in review). #105/#120 auto-closed by PR #304; #110 commented with the now-satisfied documentation criterion, benchmarking/configurability left open (not closed — real optional work remains). |
| 3   | Export page for batch scan export                                | — (the `Scan.deleted` field and its consistent `deleted: false` filtering convention already exist today; Tier 2 doesn't need to finish first) | Possibly — one new read-only IPC handler for scan enumeration by experiment/date, if none suitable exists             | [#77](https://github.com/Salk-Harnessing-Plants-Initiative/bloom-desktop/issues/77)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | **Merged** — [PR #300](https://github.com/Salk-Harnessing-Plants-Initiative/bloom-desktop/pull/300), commit `8c446ab` (2026-08-06), auto-closed #77. See `openspec/changes/archive/2026-08-06-add-cylinderscan-export-page/`. One item deliberately deferred, not fixed: [#302](https://github.com/Salk-Harnessing-Plants-Initiative/bloom-desktop/issues/302) (navigating away from Export mid-run loses progress visibility; underlying copy/data is unaffected).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| 4   | Style/UX parity pass                                             | —                                                                                                                                              | No                                                                                                                    | `align-page-layout-centering` (pending), [#104](https://github.com/Salk-Harnessing-Plants-Initiative/bloom-desktop/issues/104), [#175](https://github.com/Salk-Harnessing-Plants-Initiative/bloom-desktop/issues/175) (scoped carefully — see below), [#106](https://github.com/Salk-Harnessing-Plants-Initiative/bloom-desktop/issues/106), [#107](https://github.com/Salk-Harnessing-Plants-Initiative/bloom-desktop/issues/107)                                                                                                                                                                                    | Proposal `add-cylinderscan-style-ux-parity` fully drafted, 3-round-reviewed, and user-approved (2026-08-05) — **implementation blocked**, not merely unstarted. Its Pre-Implementation Gate (`tasks.md` §0) refuses to proceed until GraviScan [PR #289](https://github.com/Salk-Harnessing-Plants-Initiative/bloom-desktop/pull/289) and [PR #290](https://github.com/Salk-Harnessing-Plants-Initiative/bloom-desktop/pull/290) both merge to `main` — both still **open** as of 2026-08-06, and both edit the same `Layout.tsx`/`WorkflowSteps.tsx`/`ExperimentForm.tsx` this tier restructures. Worktree: `bloom-desktop-cylinderscan-tier4-style-ux`, branch `add-cylinderscan-style-ux-parity`. Re-verify the gate and rebase before resuming.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| 5a  | Packaging CI/doc prep                                            | —                                                                                                                                              | No                                                                                                                    | [#251](https://github.com/Salk-Harnessing-Plants-Initiative/bloom-desktop/issues/251), [#57](https://github.com/Salk-Harnessing-Plants-Initiative/bloom-desktop/issues/57) (bloom-desktop), [#180](https://github.com/Salk-Harnessing-Plants-Initiative/bloom-desktop/issues/180)                                                                                                                                                                                                                                                                                                                                     | **Merged** — [PR #305](https://github.com/Salk-Harnessing-Plants-Initiative/bloom-desktop/pull/305), commit `2a9c0e8` (2026-08-06), auto-closed #251/#57/#180. See `openspec/changes/archive/2026-08-06-add-cylinderscan-packaging-ci/`. Follow-ups filed, out of this tier's scope: [#293](https://github.com/Salk-Harnessing-Plants-Initiative/bloom-desktop/issues/293) (GraviScan's own hardware-doc audit), [#294](https://github.com/Salk-Harnessing-Plants-Initiative/bloom-desktop/issues/294)/[#295](https://github.com/Salk-Harnessing-Plants-Initiative/bloom-desktop/issues/295) (GraviScan Linux packaging CI, tracked as Tier 6 of the GraviScan renderer roadmap), [#296](https://github.com/Salk-Harnessing-Plants-Initiative/bloom-desktop/issues/296) (an actual release pipeline), [#303](https://github.com/Salk-Harnessing-Plants-Initiative/bloom-desktop/issues/303) (`box-backup.ts` has the same unguarded-symlink bug class this tier fixed in `database.ts`).                                                                                                                                                                                                                                                                                                                                                                                     |
| 5b  | Windows build, install, and full-workflow QA                     | 1, 2, 3                                                                                                                                        | No                                                                                                                    | (validates 1-3)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       | **Unblocked as of 2026-08-06** — Tiers 1-3 are all merged, so this tier's stated dependency is satisfied. Not started; no proposal or worktree exists yet.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
...
## Currency audit (2026-08-06)

A systematic audit against live repo/GitHub state found this table had gone
stale: Tiers 3 and 5a had both merged (PRs #300 and #305) after the doc's last
edit (`2afeff0`, ticking Tier 2) and were never ticked. Corrected above. Also
found: Tier 1's 7 tracking issues were fixed on `main` but never auto-closed
(PR #280 carried no closing keywords) — closed manually as part of this audit.
Tier 4 was previously recorded here as "not started, unblocked," which
understated its real state — a proposal is fully drafted and approved but
gated on two external GraviScan PRs merging first; see Tier 4's row.
